...
export interface paths {
    "/api/services/v2/BankAccounts": {
         ...
         * @description Returns a cursor paged list of bank accounts.
         */
        get: {
            parameters: {
                query?: {
                    ...
                    limit?: number | null;
                    /** @description Return only objects which were created from this timestamp on. Optional.
                     *     Note: Do not use timestamps for the paging of search results as there can be multiple objects with the same timestamp. */
                    createdFrom?: string | null;
                    /** @description Return only objects which were created until this timestamp. Optional.
                     *     Note: Do not use timestamps for the paging of search results as there can be multiple objects with the same timestamp. */
                    createdUntil?: string | null;
                    /** @description Return only objects which were last modified from this timestamp on. Optional.
                     *     Note: Do not use timestamps for the paging of search results as there can be multiple objects with the same timestamp. */
                    lastModifiedFrom?: string | null;
                    /** @description Return only objects which were last modified until this timestamp. Optional.
                     *     Note: Do not use timestamps for the paging of search results as there can be multiple objects with the same timestamp. */
                    ...
                    customerId?: string;
                    /** @description Return only objects with this IBAN. Optional. */
                    iban?: string;
                    /** @description Return only objects with this BIC. Optional. */
                    bic?: string;
                    /** @description Return only objects with this currency code. Optional. */
                    currencyCode?: string;
                    /** @description Return only objects with this country code. Optional. */
                    countryCode?: string;
                    /** @description Return only objects with this national bank code. Optional. */
                    bankCode?: string;
                    /** @description Return only objects with this national branch code. Optional. */
                    branchCode?: string;
                    /** @description Return only objects with this national account number. Optional. */
                    accountNumber?: string;
                    /** @description Indicates whether the full customer object should be included. Optional. */
                    includeCustomer?: boolean | null;
                    /** @description Indicates whether the full merchant object should be included. Optional. */
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetBankAccountsHttpResponse"];
                    };
                };
         ...
         * @description Creates a new bank account. The newly created resource can be referenced by the URI given by a Location header field in the response.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["CreateBankAccountHttpRequest"];
                };
            };
            responses: {
                ...
                201: {
                    ...
                    content: {
                        "application/json": components["schemas"]["CreateBankAccountHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/BankAccounts/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Returns a specific bank account.
         */
        get: {
            parameters: {
                query?: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetBankAccountHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/BankAccountBlockRules": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Returns a cursor paged list of bank account block rules.
         */
        get: {
            parameters: {
                query?: {
                    ...
                    /** @description Upper bound for the number of objects to be returned. Defaults to 50. Maximum of 500. Optional. */
                    limit?: number | null;
                    /** @description Return only block rules that are configured for this merchant id.
                     *     Optional. */
                    merchantId?: string;
                    /** @description Return only block rules that are configured for this connector id.
                     *     Optional. */
                    connectorId?: string;
                    /** @description Return only block rules that are configured to be blocked for a specific transaction type.
                     *     Optional.
                     *
                     ...
                     *     * Refund
                     *     * RequestToPay */
                    blockedTransactionType?: string;
                    /** @description Return only block rules that belong to a specific country.
                     *     Optional.
                     *     ISO 3166-1 alpha-2 country code. */
                    countryCode?: string;
                    /** @description Return only block rules for the specified IBANs.
                     *     Optional. */
                    ibans?: string[];
                    /** @description If true, also return block rules of related sub-entities.
                     *     For example include corresponding connector block rules of a merchant.
                     *     Optional.
                     *     False by default. */
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetBankAccountBlockRulesHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
         ...
         * @description Creates new bank account block rules.
         */
        put: {
            parameters: {
                query?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["CreateBankAccountBlockRulesHttpRequest"];
                };
            };
            responses: {
                /** @description Accepted. The create request has been accepted. */
                202: {
                    headers: {
                        [name: string]: unknown;
                    };
                    content: {
                        "application/json": components["schemas"]["CreateBankAccountBlockRulesHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/BankAccountBlockRules/Country": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Returns a cursor paged list of bank account country block rules.
         */
        get: {
            parameters: {
                query?: {
                    ...
                    /** @description Upper bound for the number of objects to be returned. Defaults to 50. Maximum of 500. Optional. */
                    limit?: number | null;
                    /** @description Return only objects that block specific country.
                     *     Optional. */
                    countryCode?: string;
                    /** @description Return only block rules that are configured to be blocked for a specific transaction type.
                     *     Optional.
                     ...
                     *     Optional. */
                    merchantId?: string;
                    /** @description The unique identifier of the merchant this block rules object belongs to.
                     *     Optional. */
                    connectorId?: string;
                    /** @description If true, also return block rules of related sub-entities.
                     *     For example include corresponding connector block rules of a merchant.
         ...
         * @description Creates a new bank account country block rule. The newly created resource can be referenced by the URI given by a Location header field in the response.
         */
        put: {
            parameters: {
                query?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["CreateBankAccountCountryBlockRuleHttpRequest"];
                };
            };
            responses: {
                /** @description Created. The request has been fulfilled and resulted in a new resource being created. */
                201: {
                    ...
                    content: {
                        "application/json": components["schemas"]["CreateBankAccountCountryBlockRuleHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/BankAccountBlockRules/Delete": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Deletes entities of bank account block rules.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["DeleteBankAccountBlockRulesHttpRequest"];
                };
            };
            responses: {
                /** @description Accepted. The deletion request has been accepted. */
                202: {
                    headers: {
                        [name: string]: unknown;
                    };
                    content: {
                        "application/json": components["schemas"]["DeleteBankAccountBlockRulesHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/BankAccountBlockRules/DeleteCountry": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Deletes a bank account country block rule.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["DeleteBankAccountCountryBlockRuleHttpRequest"];
                };
            };
            responses: {
                /** @description Accepted. The deletion request has been accepted. */
                202: {
                    ...
                    content: {
                        "application/json": components["schemas"]["DeleteBankAccountCountryBlockRuleHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Connectors/{id}": {
         ...
         * @description Returns a specific connector.
         */
        get: {
            parameters: {
                query?: {
                    /** @description Indicates whether the full merchant object should be included. Optional. */
                    includeMerchant?: boolean | null;
                    /** @description Indicates whether the full SchemeConfiguration object should be included. Optional. */
                    includeSchemeConfiguration?: boolean | null;
                };
                header?: never;
                path: {
                    id: string;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetConnectorHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Connectors": {
         ...
         * @description Returns a cursor paged list of connectors.
         */
        get: {
            parameters: {
                query?: {
                    ...
                    /** @description Return only objects with this merchant id. Optional. */
                    merchantId?: string;
                    /** @description Return only objects with this name. Optional. */
                    name?: string;
                    /** @description Indicates whether the full merchant object should be included. Optional. */
                    includeMerchant?: boolean | null;
                    /** @description Return only objects depending on whether the field MandateReviewEnabled is set to true or false. Optional. */
                    mandateReviewEnabled?: boolean | null;
                    /** @description Return only objects depending on whether the field PaymentReviewEnabled is set to true or false. Optional. */
                    paymentReviewEnabled?: boolean | null;
                    /** @description Return only objects depending on whether the field PayoutReviewEnabled is set to true or false. Optional. */
                    payoutReviewEnabled?: boolean | null;
                    /** @description Return only objects depending on whether the field RefundReviewEnabled is set to true or false. Optional. */
                    refundReviewEnabled?: boolean | null;
                    /** @description Indicates whether the full SchemeConfiguration object should be included. Optional. */
                    includeSchemeConfiguration?: boolean | null;
                };
                header?: never;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetConnectorsHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Customers": {
         ...
         * @description Returns a cursor paged list of customers.
         */
        get: {
            parameters: {
                query?: {
                    ...
                    /** @description Return only objects with this state. Optional. */
                    state?: string;
                    /** @description Return only objects with this email address. Optional. */
                    emailAddress?: string;
                    /** @description Return only objects with this merchant id. Optional. */
                    merchantId?: string;
                    /** @description Indicates whether the full merchant object should be included. Optional. */
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetCustomersHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
         ...
         * @description Creates a new customer. The newly created resource can be referenced by the URI given by a Location header field in the response.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["CreateCustomerHttpRequest"];
                };
            };
            responses: {
                /** @description Created. The request has been fulfilled and resulted in a new resource being created. */
                201: {
                    ...
                    content: {
                        "application/json": components["schemas"]["CreateCustomerHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetCustomerHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/HostedPages": {
         ...
         * @description Returns a cursor paged list of hosted pages.
         */
        get: {
            parameters: {
                query?: {
                    ...
                    /** @description Upper bound for the number of objects to be returned. Defaults to 50. Maximum of 500. Optional. */
                    limit?: number | null;
                    /** @description Return only objects which were created from this timestamp on.
                     *     Note: Do not use timestamps for the paging of search results as there can be multiple objects with the same timestamp. Optional. */
                    createdFrom?: string | null;
                    /** @description Return only objects which were created until this timestamp.
                     *     Note: Do not use timestamps for the paging of search results as there can be multiple objects with the same timestamp. Optional. */
                    createdUntil?: string | null;
                    /** @description Return only objects with this state. Optional. */
                    state?: string;
                    ...
                    /** @description Indicates whether the full merchant object should be included. Optional. */
                    includeMerchant?: boolean | null;
                    /** @description Indicates whether the full connector object should be included. Optional. */
                    includeConnector?: boolean | null;
                    /** @description Indicates whether the full customer object should be included. Optional. */
                    includeCustomer?: boolean | null;
                    /** @description Indicates whether the full bank account object should be included. Optional. */
                    includeBankAccount?: boolean | null;
                    /** @description Indicates whether the full mandate object should be included. Optional. */
                    includeMandate?: boolean | null;
                    /** @description Indicates whether the full payment object should be included. Optional. */
                    includePayment?: boolean | null;
                    /** @description Indicates whether the full RequestToPay object should be included. Optional. */
                    includeRequestToPay?: boolean | null;
                    /** @description Indicates whether the full refund object should be included. Optional. */
                    includeRefund?: boolean | null;
                    /** @description Indicates whether the full payout object should be included. Optional. */
                    includePayout?: boolean | null;
                };
                header?: never;
                path?: never;
                cookie?: never;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetHostedPagesHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/HostedPages/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Returns a specific hosted page.
         */
        get: {
            parameters: {
                query?: {
                    ...
                    /** @description Indicates whether the full payment object should be included. Optional. */
                    includePayment?: boolean | null;
                    /** @description Indicates whether the full RequestToPay object should be included. */
                    includeRequestToPay?: boolean | null;
                    /** @description Indicates whether the full refund object should be included. Optional. */
                    includeRefund?: boolean | null;
                    /** @description Indicates whether the full payout object should be included. Optional. */
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetHostedPageHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/HostedPages/{id}/View": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description View the hosted page. Returns HTML.
         */
        get: {
            parameters: {
                query?: {
                    /** @description The URL to which SEPAexpress redirects the customer after the hosted page process is successfully completed. */
                    successUrl?: string;
                    /** @description The URL to which SEPAexpress redirects the customer if the hosted page process fails. */
                    failUrl?: string;
                    message?: string;
                };
                header?: never;
            ...
            responses: {
                ...
                /** @description Unauthorized. The client has not provided a valid Authentication HTTP header or the user making the request has been disabled. */
                401: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                /** @description Forbidden. The client has provided a valid Authentication header, but does not have permission to access this resource. */
                403: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/api/services/v2/LocalizationTexts/{key}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Returns a specific localizationText.
         */
        get: {
            parameters: {
                query?: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetLocalizationTextHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Mandates": {
         ...
         * @description Returns a cursor paged list of mandates.
         */
        get: {
            parameters: {
                query?: {
                    ...
                    /** @description Return only objects with this payment scheme. Optional. */
                    scheme?: string;
                    /** @description Return only objects with this mandate reference. Optional. */
                    reference?: string;
                    /** @description Return only objects with this mandate type. Optional. */
                    type?: string;
                    /** @description Indicates whether the full customer object should be included. Optional. */
                    includeCustomer?: boolean | null;
                    /** @description Indicates whether the full bank account object should be included. Optional. */
                    ...
                    /** @description Indicates whether the full merchant object should be included. Optional. */
                    includeMerchant?: boolean | null;
                    /** @description Indicates whether the full hosted page object should be included. Optional. */
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetMandatesHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
         ...
         * @description Creates a new mandate. The newly created resource can be referenced by the URI given by a Location header field in the response.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["CreateMandateHttpRequest"];
                };
            };
            responses: {
                /** @description Created. The request has been fulfilled and resulted in a new resource being created. */
                201: {
                    ...
                    content: {
                        "application/json": components["schemas"]["CreateMandateHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Mandates/{id}": {
         ...
         * @description Returns a specific mandate.
         */
        get: {
            parameters: {
                query?: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetMandateHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Mandates/{id}/Approve": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Approves a mandate
         * @description Approves a mandate.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["ApproveMandateHttpRequest"];
                };
            };
            responses: {
                /** @description Ok. Standard response for successful HTTP requests. */
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["ApproveMandateHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
                ...
                /** @description Conflict. The resource to be approved by your request cannot be approved */
                409: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/api/services/v2/Mandates/{id}/Resend": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Creates a new approval TAN and re-sends it via email or sms to the customer.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["ResendMandateHttpRequest"];
                };
            };
            responses: {
                /** @description Ok. Standard response for successful HTTP requests. */
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["ResendMandateHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Mandates/{id}/Review": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Manually accept or reject this mandate.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["ReviewMandateHttpRequest"];
                };
            };
            responses: {
                /** @description Ok. Standard response for successful HTTP requests. */
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["ReviewMandateHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Mandates/{id}/Discard": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Discards a mandate
         * @description Discards a mandate. Pending dependent transactions get also aborted.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["DiscardMandateHttpRequest"];
                };
            };
            responses: {
                /** @description Ok. Standard response for successful HTTP requests. */
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["DiscardMandateHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
                ...
                /** @description Conflict. The resource to be discarded by your request cannot be discarded. */
                409: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/api/services/v2/Mandates/{id}/Reinstate": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Reinstates a discarded or expired mandate.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["ReinstateMandateHttpRequest"];
                };
            };
            responses: {
                /** @description Ok. Standard response for successful HTTP requests. */
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["ReinstateMandateHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Merchants/{id}": {
         ...
         * @description Returns a specific merchant.
         */
        get: {
            parameters: {
                query?: never;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetMerchantHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Merchants": {
         ...
         * @description Returns a cursor paged list of merchants.
         */
        get: {
            parameters: {
                query?: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetMerchantsHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Payments": {
         ...
         * @description Returns a cursor paged list of payments.
         */
        get: {
            parameters: {
                query?: {
                    /** @description Return only objects that match the specified ids. Optional. */
                    ids?: string[];
                    /** @description Return only objects after this cursor id. Optional. */
                    after?: string;
                    /** @description Return only objects before this cursor id. Optional. */
                    ...
                    /** @description Return only objects with this bank account id. Optional. */
                    bankAccountId?: string;
                    /** @description Return only objects with this mandate id. Optional. */
                    mandateId?: string;
                    ...
                    /** @description Indicates whether the full hosted page object should be included. Optional. */
                    includeHostedPage?: boolean | null;
                    /** @description Return only objects which were submitted at this timestamp. */
                    submittedUntil?: string | null;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetPaymentsHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
         ...
         * @description Creates a new payment. The newly created resource can be referenced by the URI given by a Location header field in the response.
         */
        post: {
            parameters: {
                query?: never;
            ...
            responses: {
                ...
                201: {
                    ...
                    content: {
                        "application/json": components["schemas"]["CreatePaymentHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
                ...
                /** @description Unprocessable. The request was well-formed but could not be processed due to other reasons. */
                422: {
                    headers: {
                        [name: string]: unknown;
                    };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetPaymentHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Payments/{id}/Review": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Manually accept or reject this payment.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": components["schemas"]["ReviewPaymentHttpRequest"];
                };
            };
            responses: {
                /** @description Ok. Standard response for successful HTTP requests. */
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["ReviewPaymentHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Reconciliations/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Returns a specific reconciliation.
         */
        get: {
            parameters: {
                query?: {
                    ...
                    /** @description Indicates whether the full requestToPay object should be included. Optional. */
                    includeRequestToPay?: boolean | null;
                    /** @description Indicates whether the full HostedPage object should be included. Optional. */
                    includeHostedPage?: boolean | null;
                };
                header?: never;
                path: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetReconciliationHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
    ...
    "/api/services/v2/Reconciliations": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Returns a cursor paged list of reconciliations.
         */
        get: {
            parameters: {
                query?: {
                     ...
                     *     Note: Do not use timestamps for the paging of search results as there can be multiple objects with the same timestamp. */
                    createdUntil?: string | null;
                    /** @description Return only objects which were booked from this timestamp on. Optional.
                     *     Note: Do not use timestamps for the paging of search results as there can be multiple objects with the same timestamp. */
                    bookingDateFrom?: string | null;
                    /** @description Return only objects which were booked until this timestamp. Optional.
                     *     Note: Do not use timestamps for the paging of search results as there can be multiple objects with the same timestamp. */
                    bookingDateUntil?: string | null;
                    /** @description Return only objects with this state. Optional. */
                    state?: string;
                    /** @description Return only objects with this merchantId. Optional. */
                    merchantId?: string;
                    /** @description Return only objects with this connectorId. Optional. */
                    connectorId?: string;
                    /** @description Return only objects with this customerId. Optional. */
                    customerId?: string;
                    /** @description Return only objects with this bankAccountId. Optional. */
                    bankAccountId?: string;
                    /** @description Return only objects with this mandateId. Optional. */
                    mandateId?: string;
                    /** @description Return only objects with this paymentId. Optional. */
                    paymentId?: string;
                    /** @description Return only objects with this refundId. Optional. */
                    refundId?: string;
                    /** @description Return only objects with this payoutId. Optional. */
                    payoutId?: string;
                    /** @description Return only objects with this requestToPayId. Optional. */
                    requestToPayId?: string;
                    /** @description Return only objects with this hostedPageId. Optional. */
                    hostedPageId?: string;
                    /** @description Return only objects for this entity. Optional. */
                    entity?: string;
                    /** @description Return only objects with this IBAN. Optional. */
                    iban?: string;
                    /** @description Return only objects with this currency code. Optional. */
                    currencyCode?: string;
                    /** @description Return only objects with this reference. Optional. */
                    reference?: string;
                    /** @description Return only objects with this idempotencyKey. Optional. */
                    idempotencyKey?: string;
                    /** @description Return only objects with this cause. Optional. */
                    cause?: string;
                    /** @description Return only objects with this payment scheme. Optional. */
                    scheme?: string;
                    /** @description Return only objects with this reason code. Optional. */
                    reasonCode?: string;
                    /** @description Indicates whether the full merchant object should be included. Optional. */
                    includeMerchant?: boolean | null;
                    /** @description Indicates whether the full connector object should be included. Optional. */
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetReconciliationsHttpResponse"];
                    };
                };
                /** @description Bad Request. The request could not be understood by the server, usually due to malformed syntax. */
                400: {
...
export interface components {
    schemas: {
        CreateBankAccountHttpRequest: {
             ...
             *     For most countries, especially in the SEPA area, using the IBAN is the required way to specify a bank account.
             *     Optional when nested in hosted page or request to pay.
             *     For non-SEPA-Schemes, the country code and the national fields can be used. (bankCode, branchCode, accountNumber) */
            iban: string;
        ...
        CreatePaymentHttpRequest: {
            ...
            /** @description Custom5 for free use by the PSP. */
            custom5?: string;
            /** @description If provided will the payment be settled to this creditor IBAN. */
            creditorIban?: string;
            /** @description If provided will the payment be settled to this creditor BIC. */
            creditorBic?: string;
        };
        ...
        BankAccount: {
            ...
            /** @description Memo for free use by the PSP */
            memo?: string;
            /** @description Field for internal free use by SPX */
            internalNote?: string;
        };
        ...
        rtpProviderRoute: {
            countryCode?: string;
            bic?: string;
            providers?: ("Unknown" | "TinkPis" | "Ixo" | "TokenIoPis" | "VoltPis")[];
        };
        ...
        voltConfig: {
            /** @description like https://api.sandbox.volt.io */
            baseApiUri?: string;
            clientId?: string;
            clientSecret?: string;
            username?: string;
